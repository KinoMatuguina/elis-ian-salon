...
async function getStaticProps() {
    ...
    const fetchWorkers = async ()=>{
        const res = await _firebase__WEBPACK_IMPORTED_MODULE_2__.db.collection("Workers").get();
...
var __webpack_exports__ = __webpack_require__.X(0, [291], () => (__webpack_exec__(952)));
